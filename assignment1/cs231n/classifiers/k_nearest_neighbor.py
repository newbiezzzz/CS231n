...
class KNearestNeighbor(object):
    ...
    def compute_distances_two_loops(self, X):
        ...
        for i in range(num_test):
            for j in range(num_train):
                ...
                # test = 500 * 3072, train = 5000 * 3072, dist = 500 * 5000
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in range(num_test):
            ...
            # closest_y's dimension is 500 x k
            # np.argsort(dists) = closest index for label (500 x 5000)
            # self.y_train is 5000 long
            ...
            # y_predict is a 500 long, closest_y is 500 x k
